...
async function runTests() {
    ...
    const configExists = fs.existsSync(path.join(projectRoot, 'firebase.ts')) ||
        fs.existsSync(path.join(projectRoot, 'config/firebase.js'));
    ...
    const shopExists = fs.existsSync(path.join(projectRoot, 'Shop.tsx'));
